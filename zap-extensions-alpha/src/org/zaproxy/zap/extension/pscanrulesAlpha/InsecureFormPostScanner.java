 ...
 * rule {@code CasabaSecurity.Web.Watcher.Checks.CheckPasvSSLInsecureFormPost}
 */
public class InsecureFormPostScanner extends PluginPassiveScanner {
	 ...
	 */
	private static final String MESSAGE_PREFIX = "pscanalpha.insecureformpost.";
